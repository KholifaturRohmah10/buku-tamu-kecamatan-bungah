...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        @php
            ...
            $saranEntries = $entries->filter(fn ($entry) => filled($entry->saran));
        ...
        <div class="page">
            @if ($showActions)
                <div class="actions">
                    <a href="{{ route('admin.dashboard', $filters) }}" class="button">Kembali ke Admin</a>
                    <a href="{{ route('admin.kunjungan-tamu.export', ['format' => 'pdf'] + $filters) }}" class="button">Export PDF</a>
                    <a href="{{ route('admin.kunjungan-tamu.export', ['format' => 'excel'] + $filters) }}" class="button">Export Excel</a>
            ...
            <section class="panel">
                ...
                <h1 class="report-title">Laporan Buku Tamu dan Survei Kepuasan Masyarakat</h1>
                    ...
                    <table class="summary-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:center;">{{ $summary['survey']['overall'] !== null ? number_format($summary['survey']['overall'], 1) . ' / 5' : '-' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </section>
                ...
                <section class="section">
                    ...
                    <table class="survey-table">
                        ...
                        <tbody>
                            <tr>
                                <td>Pelayanan</td>
                                <td style="text-align:center;">{{ $summary['survey']['service'] !== null ? number_format($summary['survey']['service'], 1) . ' / 5' : '-' }}</td>
                            </tr>
                            <tr>
                                <td>Kecepatan</td>
                                <td style="text-align:center;">{{ $summary['survey']['speed'] !== null ? number_format($summary['survey']['speed'], 1) . ' / 5' : '-' }}</td>
                            </tr>
                            <tr>
                                <td>Fasilitas</td>
                                <td style="text-align:center;">{{ $summary['survey']['facility'] !== null ? number_format($summary['survey']['facility'], 1) . ' / 5' : '-' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </section>
                ...
                <section class="section">
                    <h2>Saran Perbaikan dari Masyarakat</h2>

                    @if ($saranEntries->isEmpty())
                        <div class="empty">Tidak terdapat saran perbaikan pada data yang ditampilkan.</div>
                    @else
